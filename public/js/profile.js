...
<div class="contact_form_text">
    ...
    <div class="form-group">
        <input type="text" class="form-control" id="name" name="name" value="${localStorage.getItem(
          'name'
        )}" placeholder="Full  name">
    </div>
    <div class="form-group">
        <input type="email" class="form-control" id="email" name="email" value="${localStorage.getItem(
          'email'
        )}" placeholder="email">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" id="facebook" name="facebook" value="${localStorage.getItem(
          'facebook'
        )}" placeholder="Facebook link">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" id="twitter" name="twitter" value="${localStorage.getItem(
          'twitter'
        )}" placeholder="Twitter link">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" id="github" name="github" value="${localStorage.getItem(
          'github'
        )}" placeholder="Github link">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" id="behance" name="behance" value="${localStorage.getItem(
          'behance'
...
<div class="contact_form_message">
    <div class="form-group">
        <textarea class="form-control" name="caption" id="caption" rows="1" value="${localStorage.getItem(
          'caption'
...
<div class="contact_form_text">
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="npassword" name="password" value="${localStorage.getItem(
          'npassword'
        )}" placeholder="New password">
    </div>
    <div class="form-group">
        <label for="chagepn">Confirm New Password</label>
        <input type="password" class="form-control" id="cnpassword" name="password" value="${localStorage.getItem(
          'cnpassword'
...
contactform.addEventListener('submit', e => {
  ...
  if (oldpassword !== localStorage.getItem('oldpassword')) {
