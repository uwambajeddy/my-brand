...
if(localStorage.getItem("isLoggedIn") !== localStorage.getItem("oldpassword")){
...
contactform.addEventListener('submit',(e)=>{
    ...
    const items = [`name:${name}`,`facebook:${facebook}`,`twitter:${twitter}`,`github:${github}`,`behance:${behance}`,`caption:${caption}`,`npassword:${npassword}`,`cnpassword:${cnpassword}`]
    items.map(item=>{
